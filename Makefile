...
SOURCES = \
	__init__.py \
	nvdb_qgis_plugin.py nvdb_qgis_plugin_dialog.py

PLUGINNAME = nvdb_qgis_plugin

PY_FILES = \
	__init__.py \
	nvdb_qgis_plugin.py nvdb_qgis_plugin_dialog.py

UI_FILES = nvdb_qgis_plugin_dialog_base.ui
...
QGISDIR=C:\Users\ekbe_\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
